...
func NewFsMountpointCommand(dingoadm *cli.DingoAdm) *cobra.Command {
...
func runMountpoint(cmd *cobra.Command, dingoadm *cli.DingoAdm, options deleteOptions) error {
	// new rpc
